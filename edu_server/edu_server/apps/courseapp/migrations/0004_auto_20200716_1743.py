# Generated by Django 2.0.6 on 2020-07-16 09:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courseapp', '0003_auto_20200714_1957'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_expire', to='courseapp.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程有效期',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('edit_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('active', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='activecourses', to='courseapp.Activity', verbose_name='活动')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activeprices', to='courseapp.Course', verbose_name='课程')),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discountcourse', to='courseapp.CourseDiscount', verbose_name='优惠折扣')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='discount_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursediscounts', to='courseapp.CourseDiscountType', verbose_name='优惠类型'),
        ),
    ]
