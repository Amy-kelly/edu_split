# Generated by Django 2.0.6 on 2020-07-08 11:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Carousel',
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='homeapp.BaseModel')),
                ('img', models.ImageField(max_length=255, upload_to='carousel', verbose_name='轮播图图片')),
