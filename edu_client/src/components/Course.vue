    ...
    export default {
        ...
        methods: {
            ...
            get_course_list() {
                ...
                this.$axios.get(`http://127.0.0.1:8000/courseapp/course_filter/`, {
                    params: filters
                }).then(response => {
            ...
            // 获取所有分类信息
            get_all_category() {
                this.$axios.get(`http://127.0.0.1:8000/courseapp/category/`).then(response => {
...
<style scoped>
 .course {
    ...
    .course-item .lesson-list li {
        ...
        background: url("/static/image") no-repeat left 4px;
        margin-bottom: 15px;
    }
