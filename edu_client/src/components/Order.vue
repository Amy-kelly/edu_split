        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in course_list">
                <el-row>
                    ...
                    原价:<span style="text-decoration: line-through">¥{{course.price}}</span>
                    </el-col>
                </el-row>
            </div>
            <div class="calc">
...
<script>
    export default {
        ...
        methods:{
            ...
            //获取购物车中所有已勾选的方法
            get_select_course(){
                this.$axios.get("http://127.0.0.1:8000/cartapp/order/",{
                    headers:{
            ...
            pay_order(){
                ...
                this.$axios({
                    url:"http://127.0.0.1:8000/orderapp/pay_order/",
                    method:"post",
                    data:{
