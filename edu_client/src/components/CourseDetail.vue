                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div v-for="(chapter,index1) in course.chapter_list" class="chapter-item" >
                            ...
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(lesson,index2) in chapter.lesson_list" >
                                    <p class="name">
                                        <span class="index">{{index1+1}}-{{index2+1}}</span> {{lesson.name}}<span v-if="lesson.free_trail" class="free">免费</span>
                                    </p>
